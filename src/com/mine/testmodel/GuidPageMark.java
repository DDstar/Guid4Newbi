...
public class GuidPageMark {

	public static final String SHAREDPREFERENCES_NAME = "com.kdt.emic_oa.my_pref";
	private static final String KEY_GUIDE_ACTIVITY = "com.kdt.emic_oa.guide_activity";
	...
	public static boolean activityIsGuided(Context context, String className) {
		...
		String[] classNames = context
				.getSharedPreferences(SHAREDPREFERENCES_NAME,
						Context.MODE_PRIVATE).getString(KEY_GUIDE_ACTIVITY, "")
				.split("\\|");// 取得所有类名 如
								// com.my.MainActivity
